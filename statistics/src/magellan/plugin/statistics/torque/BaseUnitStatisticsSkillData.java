 ...
 * extended all references should be to UnitStatisticsSkillData
 */
public abstract class BaseUnitStatisticsSkillData extends BaseObject
{
    /** Serial version */
    private static final long serialVersionUID = 1212305538510L;

    /** The Peer class */
    private static final UnitStatisticsSkillDataPeer peer =
        new UnitStatisticsSkillDataPeer();
    ...
    public void setSkill(String v) 
    {
        ...
        if (!ObjectUtils.equals(this.skill, v))
        {
            this.skill = v;
            setModified(true);
        }
    ...
    {
        if (name.equals(UnitStatisticsSkillDataPeer.ID))
        {
            return new Long(getID());
        }
        if (name.equals(UnitStatisticsSkillDataPeer.TURN_ID))
        {
            return new Long(getTurnId());
        }
        if (name.equals(UnitStatisticsSkillDataPeer.UNIT_ID))
        {
            return new Long(getUnitId());
        }
        if (name.equals(UnitStatisticsSkillDataPeer.SKILL))
        {
            return getSkill();
        }
        if (name.equals(UnitStatisticsSkillDataPeer.LEVEL))
        {
            return new Integer(getLevel());
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (UnitStatisticsSkillDataPeer.ID.equals(name))
        {
            return setByName("ID", value);
        }
      if (UnitStatisticsSkillDataPeer.TURN_ID.equals(name))
        {
            return setByName("TurnId", value);
        }
      if (UnitStatisticsSkillDataPeer.UNIT_ID.equals(name))
        {
            return setByName("UnitId", value);
        }
      if (UnitStatisticsSkillDataPeer.SKILL.equals(name))
        {
            return setByName("Skill", value);
        }
      if (UnitStatisticsSkillDataPeer.LEVEL.equals(name))
        {
    ...
    {
        save(UnitStatisticsSkillDataPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    UnitStatisticsSkillDataPeer.doInsert((UnitStatisticsSkillData) this, con);
                    setNew(false);
                }
                else
                {
                    UnitStatisticsSkillDataPeer.doUpdate((UnitStatisticsSkillData) this, con);
                }
            }
     ...
     */
    public UnitStatisticsSkillData copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public UnitStatisticsSkillData copy(Connection con) throws TorqueException
    {
     ...
     */
    public UnitStatisticsSkillData copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new UnitStatisticsSkillData(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public UnitStatisticsSkillData copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new UnitStatisticsSkillData(), deepcopy, con);
    }
     ...
     */
    protected UnitStatisticsSkillData copyInto(UnitStatisticsSkillData copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected UnitStatisticsSkillData copyInto(UnitStatisticsSkillData copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected UnitStatisticsSkillData copyInto(UnitStatisticsSkillData copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setID(iD);
        copyObj.setTurnId(turnId);
        copyObj.setUnitId(unitId);
        copyObj.setSkill(skill);
     ...
     * @param con the database connection to read associated objects.
     */
    protected UnitStatisticsSkillData copyInto(UnitStatisticsSkillData copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setID(iD);
        copyObj.setTurnId(turnId);
        copyObj.setUnitId(unitId);
     ...
     */
    public UnitStatisticsSkillDataPeer getPeer()
    {
        return peer;
    }
    ...
    {
        return UnitStatisticsSkillDataPeer.getTableMap();
    }
    ...
    public String toString()
    {
        ...
        str.append("UnitStatisticsSkillData:\n");
        str.append("ID = ")
           .append(getID())
           .append("\n");
        str.append("TurnId = ")
