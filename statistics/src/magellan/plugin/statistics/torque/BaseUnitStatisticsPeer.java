...
import magellan.plugin.statistics.torque.map.UnitStatisticsMapBuilder;
 ...
 *
 */
public abstract class BaseUnitStatisticsPeer
    extends BasePeer
{
    /** Serial version */
     ...
     * @deprecated Torque.getMapBuilder(UnitStatisticsMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(UnitStatisticsMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        TABLE_NAME = "unit_statistics";

        ID = "unit_statistics.id";
        REPORT_ID = "unit_statistics.report_id";
        UNIT_NUMBER = "unit_statistics.unit_number";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(UnitStatisticsMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(UnitStatisticsMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "magellan.plugin.statistics.torque.UnitStatistics";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UnitStatistics> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(UNIT_NUMBER);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static UnitStatistics row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            UnitStatistics obj = (UnitStatistics) cls.newInstance();
            UnitStatisticsPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setUnitNumber(row.getValue(offset + 2).asString());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UnitStatistics> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UnitStatistics> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UnitStatistics> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<UnitStatistics> results = new ArrayList<UnitStatistics>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(UnitStatisticsPeer.row2Object(row, 1,
                UnitStatisticsPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UnitStatistics> doSelect(UnitStatistics obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(UnitStatistics obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(UnitStatistics obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(UnitStatistics obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(UnitStatistics) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(UnitStatistics obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(UnitStatistics) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(UnitStatistics obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(UnitStatistics) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(UnitStatistics obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( UnitStatistics obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(ID, obj.getID());
        criteria.add(REPORT_ID, obj.getReportId());
        criteria.add(UNIT_NUMBER, obj.getUnitNumber());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( UnitStatistics obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static UnitStatistics retrieveByPK(long pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static UnitStatistics retrieveByPK(long pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static UnitStatistics retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        UnitStatistics retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static UnitStatistics retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<UnitStatistics> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UnitStatistics> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<UnitStatistics> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<UnitStatistics> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<UnitStatistics> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<UnitStatistics>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of UnitStatistics objects pre-filled with their
     * Report objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in UnitStatisticsPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<UnitStatistics> doSelectJoinReport(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<UnitStatistics> doSelectJoinReport(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(UnitStatisticsPeer.REPORT_ID,
            ReportPeer.ID);
        ...
        List<UnitStatistics> results = new ArrayList<UnitStatistics>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = UnitStatisticsPeer.getOMClass();
            UnitStatistics obj1 = (UnitStatistics) UnitStatisticsPeer
            ...
            {
                UnitStatistics temp_obj1 =  results.get(j);
                Report temp_obj2 = (Report) temp_obj1.getReport();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addUnitStatistics(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initUnitStatisticss();
                obj2.addUnitStatistics(obj1);
            }
            results.add(obj1);
        }
        return results;
