...
import magellan.plugin.statistics.torque.map.FactionStatisticsMapBuilder;
 ...
 *
 */
public abstract class BaseFactionStatisticsPeer
    extends BasePeer
{
    /** Serial version */
     ...
     * @deprecated Torque.getMapBuilder(FactionStatisticsMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(FactionStatisticsMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the faction_number field */
    public static final String FACTION_NUMBER;

    static
    {
        DATABASE_NAME = "statistics";
        TABLE_NAME = "faction_statistics";

        ID = "faction_statistics.id";
        REPORT_ID = "faction_statistics.report_id";
        FACTION_NUMBER = "faction_statistics.faction_number";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(FactionStatisticsMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(FactionStatisticsMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "magellan.plugin.statistics.torque.FactionStatistics";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<FactionStatistics> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseFactionStatisticsPeer
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(FACTION_NUMBER);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static FactionStatistics row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            FactionStatistics obj = (FactionStatistics) cls.newInstance();
            FactionStatisticsPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setFactionNumber(row.getValue(offset + 2).asString());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<FactionStatistics> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<FactionStatistics> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<FactionStatistics> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<FactionStatistics> results = new ArrayList<FactionStatistics>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(FactionStatisticsPeer.row2Object(row, 1,
                FactionStatisticsPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<FactionStatistics> doSelect(FactionStatistics obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(FactionStatistics obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(FactionStatistics obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(FactionStatistics obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(FactionStatistics) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(FactionStatistics obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(FactionStatistics) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(FactionStatistics obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(FactionStatistics) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(FactionStatistics obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( FactionStatistics obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(ID, obj.getID());
        criteria.add(REPORT_ID, obj.getReportId());
        criteria.add(FACTION_NUMBER, obj.getFactionNumber());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( FactionStatistics obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static FactionStatistics retrieveByPK(long pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static FactionStatistics retrieveByPK(long pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static FactionStatistics retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        FactionStatistics retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static FactionStatistics retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<FactionStatistics> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (FactionStatistics)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<FactionStatistics> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<FactionStatistics> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<FactionStatistics> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<FactionStatistics> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<FactionStatistics>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of FactionStatistics objects pre-filled with their
     * Report objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in FactionStatisticsPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<FactionStatistics> doSelectJoinReport(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<FactionStatistics> doSelectJoinReport(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(FactionStatisticsPeer.REPORT_ID,
            ReportPeer.ID);
        ...
        List<FactionStatistics> results = new ArrayList<FactionStatistics>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = FactionStatisticsPeer.getOMClass();
            FactionStatistics obj1 = (FactionStatistics) FactionStatisticsPeer
            ...
            {
                FactionStatistics temp_obj1 =  results.get(j);
                Report temp_obj2 = (Report) temp_obj1.getReport();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addFactionStatistics(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initFactionStatisticss();
                obj2.addFactionStatistics(obj1);
            }
            results.add(obj1);
        }
        return results;
