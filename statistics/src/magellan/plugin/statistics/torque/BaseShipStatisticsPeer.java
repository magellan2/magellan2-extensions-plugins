...
import magellan.plugin.statistics.torque.map.ShipStatisticsMapBuilder;
 ...
 *
 */
public abstract class BaseShipStatisticsPeer
    extends BasePeer
{
    /** Serial version */
     ...
     * @deprecated Torque.getMapBuilder(ShipStatisticsMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(ShipStatisticsMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        TABLE_NAME = "ship_statistics";

        ID = "ship_statistics.id";
        REPORT_ID = "ship_statistics.report_id";
        SHIP_NUMBER = "ship_statistics.ship_number";
        TYPE = "ship_statistics.type";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(ShipStatisticsMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(ShipStatisticsMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "magellan.plugin.statistics.torque.ShipStatistics";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ShipStatistics> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static ShipStatistics row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            ShipStatistics obj = (ShipStatistics) cls.newInstance();
            ShipStatisticsPeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ShipStatistics> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ShipStatistics> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ShipStatistics> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<ShipStatistics> results = new ArrayList<ShipStatistics>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(ShipStatisticsPeer.row2Object(row, 1,
                ShipStatisticsPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ShipStatistics> doSelect(ShipStatistics obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(ShipStatistics obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(ShipStatistics obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(ShipStatistics obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(ShipStatistics) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(ShipStatistics obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(ShipStatistics) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(ShipStatistics obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(ShipStatistics) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(ShipStatistics obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( ShipStatistics obj )
    {
    ...
    public static Criteria buildSelectCriteria( ShipStatistics obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static ShipStatistics retrieveByPK(long pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static ShipStatistics retrieveByPK(long pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static ShipStatistics retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        ShipStatistics retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static ShipStatistics retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<ShipStatistics> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ShipStatistics> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<ShipStatistics> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ShipStatistics> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<ShipStatistics> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<ShipStatistics>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of ShipStatistics objects pre-filled with their
     * Report objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in ShipStatisticsPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<ShipStatistics> doSelectJoinReport(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<ShipStatistics> doSelectJoinReport(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(ShipStatisticsPeer.REPORT_ID,
            ReportPeer.ID);
        ...
        List<ShipStatistics> results = new ArrayList<ShipStatistics>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = ShipStatisticsPeer.getOMClass();
            ShipStatistics obj1 = (ShipStatistics) ShipStatisticsPeer
            ...
            {
                ShipStatistics temp_obj1 =  results.get(j);
                Report temp_obj2 = (Report) temp_obj1.getReport();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addShipStatistics(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initShipStatisticss();
                obj2.addShipStatistics(obj1);
            }
            results.add(obj1);
        }
        return results;
