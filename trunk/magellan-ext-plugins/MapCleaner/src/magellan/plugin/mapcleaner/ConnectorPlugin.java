...
public class ConnectorPlugin implements MagellanPlugIn, ActionListener{
	   ...
	   */
	  private ArrayList<MapCleanAction> cleanActions = null; 
	  ...
	  public void init(Client client, Properties properties){
		...
		this.cleanActions.add(new RemoveWrongRessources());
	  ...
	  public List<JMenuItem> getMenuItems(){
		  ...
		  // Submenus
		  for (Iterator<MapCleanAction> iter = this.cleanActions.iterator();iter.hasNext();){
			  MapCleanAction actAction = (MapCleanAction)iter.next();
