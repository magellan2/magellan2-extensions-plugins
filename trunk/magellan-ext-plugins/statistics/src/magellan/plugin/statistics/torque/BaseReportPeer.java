...
import magellan.plugin.statistics.torque.map.ReportMapBuilder;
    ...
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(ReportMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(ReportMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the lastsave field */
    public static final String LASTSAVE;
    ...
    static
    {
        ...
        LASTSAVE = "report.lastsave";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(ReportMapBuilder.CLASS_NAME);
            }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "magellan.plugin.statistics.torque.Report";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Report> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(LASTSAVE);
    }
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setFilename(row.getValue(offset + 1).asString());
            obj.setLastSave(row.getValue(offset + 2).asLong());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Report> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Report> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Report> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<Report> results = new ArrayList<Report>(records.size());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Report> doSelect(Report obj) throws TorqueException
    {
    ...
    public static Criteria buildCriteria( Report obj )
    {
        ...
        criteria.add(LASTSAVE, obj.getLastSave());
        return criteria;
    }
     ...
     */
    public static Report retrieveByPK(long pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Report retrieveByPK(long pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        ...
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        ...
        List<Report> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Report> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Report> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<Report> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<Report>();
        }
        else
        {
            Criteria criteria = new Criteria();
