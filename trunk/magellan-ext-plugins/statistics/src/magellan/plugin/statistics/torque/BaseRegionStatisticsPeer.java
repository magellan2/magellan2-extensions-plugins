...
import magellan.plugin.statistics.torque.map.RegionStatisticsMapBuilder;
 ...
 *
 */
public abstract class BaseRegionStatisticsPeer
    extends BasePeer
{
    /** Serial version */
     ...
     * @deprecated Torque.getMapBuilder(RegionStatisticsMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(RegionStatisticsMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the region_number field */
    ...
    static
    {
        ...
        ID = "region_statistics.id";
        REPORT_ID = "region_statistics.report_id";
        REGION_NUMBER = "region_statistics.region_number";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(RegionStatisticsMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(RegionStatisticsMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "magellan.plugin.statistics.torque.RegionStatistics";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RegionStatistics> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseRegionStatisticsPeer
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(REGION_NUMBER);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static RegionStatistics row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            RegionStatistics obj = (RegionStatistics) cls.newInstance();
            RegionStatisticsPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setRegionNumber(row.getValue(offset + 2).asString());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RegionStatistics> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RegionStatistics> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RegionStatistics> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<RegionStatistics> results = new ArrayList<RegionStatistics>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(RegionStatisticsPeer.row2Object(row, 1,
                RegionStatisticsPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RegionStatistics> doSelect(RegionStatistics obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(RegionStatistics obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(RegionStatistics obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(RegionStatistics obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(RegionStatistics) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(RegionStatistics obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(RegionStatistics) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(RegionStatistics obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(RegionStatistics) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(RegionStatistics obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( RegionStatistics obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(ID, obj.getID());
        criteria.add(REPORT_ID, obj.getReportId());
        criteria.add(REGION_NUMBER, obj.getRegionNumber());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( RegionStatistics obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static RegionStatistics retrieveByPK(long pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static RegionStatistics retrieveByPK(long pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static RegionStatistics retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        RegionStatistics retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static RegionStatistics retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<RegionStatistics> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (RegionStatistics)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RegionStatistics> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<RegionStatistics> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RegionStatistics> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<RegionStatistics> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<RegionStatistics>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of RegionStatistics objects pre-filled with their
     * Report objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in RegionStatisticsPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<RegionStatistics> doSelectJoinReport(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<RegionStatistics> doSelectJoinReport(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(RegionStatisticsPeer.REPORT_ID,
            ReportPeer.ID);
        ...
        List<RegionStatistics> results = new ArrayList<RegionStatistics>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = RegionStatisticsPeer.getOMClass();
            RegionStatistics obj1 = (RegionStatistics) RegionStatisticsPeer
            ...
            {
                RegionStatistics temp_obj1 =  results.get(j);
                Report temp_obj2 = (Report) temp_obj1.getReport();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addRegionStatistics(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initRegionStatisticss();
                obj2.addRegionStatistics(obj1);
            }
            results.add(obj1);
        }
        return results;
